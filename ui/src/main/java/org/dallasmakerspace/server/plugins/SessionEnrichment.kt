...
/**
 * Plugin that enriches the UserSession with user information after authentication.
 * This ensures userId is available early in the request pipeline for logging (MDC).
 */
val SessionEnrichmentPlugin = createApplicationPlugin(name = "SessionEnrichment") {
